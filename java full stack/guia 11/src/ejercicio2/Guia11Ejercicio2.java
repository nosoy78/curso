...
public class Guia11Ejercicio2 {
    ...
    public static void main(String[] args) {
         ...
         * se moja. Las clases por hacer del juego son las siguientes: Clase
         ...
         * por defecto será 6. Métodos: • disparo(Revolver r): el método, recibe
         * el revolver de agua y llama a los métodos de mojar() y
         ...
         * jugador se moja y se termina el juego, sino se moja, se pasa al

...
import Ejercicio4Extra.entidades.Estudiantes;
            ...
            switch (var) {
                case 1:
                    ...
                    do {
                        ...
                        PersonalServicios objeto1 = new PersonalServicios("Sección A", 2018, 123, "Juanita", "Soldario", "Soltero", 4567890);
                        PersonalServicios objeto2 = new PersonalServicios("Sección B", 2020, 456, "Analia", "Maratea", "Casada", 9876543);
                ...
                case 2:
                    ...
                    do {
                        ...
                        Profesor objeto3 = new Profesor("Departamento de Matemáticas", 2015, 101, "Marcelo", "Condor", "Casado", 1234567);
                        Profesor objeto4 = new Profesor("Departamento de Historia", 2019, 202, "Sol", "Amanecer", "Soltera", 9876543);
                ...
                case 3:
                    String op;
                    do {
                        estudiantes.add(ingresarEstudiante()); 

                       
                        estudiantes.add(new Estudiantes(33456, "Maria", "solano", "soltero", 123456));
                        estudiantes.add(new Estudiantes(989898, "juan", "salario", "casado", 555456));

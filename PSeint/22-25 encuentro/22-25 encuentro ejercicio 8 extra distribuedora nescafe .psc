...
SubProceso totventasvendedor(matrix, vectorA, vectorB)
	definir i, j, aux, suma Como Entero 
	hacer 
	Escribir "Que vendedor quiere saber su total de ventas"
	para i<-0 Hasta 3 Hacer
	...
	Segun aux-1 Hacer
		0:
			Escribir "El vendedor " vectorA(0) " vendio en zona Norte: " matrix(0,0) " Sur: " matrix(0,1) " Este: " matrix(0,2) " Oeste: " matrix(0,3) " Centro: " matrix(0,4)
		1:
			Escribir "El vendedor " vectorA(1) " vendio en zona Norte: " matrix(1,0) " Sur: " matrix(1,1) " Este: " matrix(1,2) " Oeste: " matrix(1,3) " Centro: " matrix(1,4)
		2: 
			Escribir "El vendedor " vectorA(2) " vendio en zona Norte: " matrix(2,0) " Sur: " matrix(2,1) " Este: " matrix(2,2) " Oeste: " matrix(2,3) " Centro: " matrix(2,4) 
		3:
			Escribir "El vendedor " vectorA(3) " vendio en zona Norte: " matrix(3,0) " Sur: " matrix(3,1) " Este: " matrix(3,2) " Oeste: " matrix(3,3) " Centro: " matrix(3,4)
		De Otro Modo:
			Escribir "nada"
	Fin Segun
FinSubProceso

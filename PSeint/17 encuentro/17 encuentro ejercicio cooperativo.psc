...
SubProceso calcularPisos()
	definir largo, ancho, superficioP, total como real 
	definir respuesta Como Caracter
	hacer
	Escribir "ingrese largo y ancho del piso" 
	leer largo, ancho 
	superficioP = (largo * ancho)
	Total = superficioP * 0.10 + superficioP
	Escribir "la supercie del piso es de : " total " m2"
	Escribir "-------------------------------------------------------------"
	Escribir "Quiere volver al menu?"
	leer respuesta
